...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private final CustomOauth2UserServie customOauth2UserServie;
    ...
    protected void configure(HttpSecurity http)throws Exception{
        http
                ...
                .antMatchers("/","/css/**", "/images/**",//권한 관리 대상 지정, URL, HTTP메소드 별로 관리 가능 ,"/"등 지정된 URLEMFDMS
                        "/js/**", "h2-console/**").permitAll()//permitaAll()옵션으로 전체 열람 권한 줌
